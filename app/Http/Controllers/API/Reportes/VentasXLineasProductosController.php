...
class VentasXLineasProductosController extends Controller
{
    public function Consultar(Request $request){
        try {
            ...
            $codigosTiendas = $datos['stores_list'];
            $queryType = $datos['query_type'];
            $reporte = DB::select("CALL x_VentasPorLineaProducto(?,?,?,?)", [$codigosTiendas, $fechaInicio, $fechaFin, $queryType]);
